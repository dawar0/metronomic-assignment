...
>(({ className, children, ...props }, ref) => {
  return (
    <SelectPrimitive.Trigger
      ref={ref}
      className={cn(
        "flex h-[32px] w-full items-center border-[#919EAB] data-[placeholder]:opacity-[55%] data-[placeholder]:text-[#97A0B1] justify-between rounded-md border  bg-white px-3 py-2  ring-offset-white text-sm font-normal hover:border-[#97A0B1] focus:outline-none focus:ring-0  disabled:cursor-not-allowed disabled:opacity-50 [&>span]:line-clamp-1",
        className
      )}
      {...props}
    >
